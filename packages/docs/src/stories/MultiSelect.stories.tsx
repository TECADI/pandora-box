...
export default {
  ...
  args: {
    ...
    options: [
      ...
      { value: '5', label: 'Option 11' },
      { value: '6', label: 'Option 21' },
      { value: '7', label: 'Option 31' },
      { value: '8', label: 'Option 41' },
      { value: '9', label: 'Option 12' },
      { value: '10', label: 'Option 22' },
      { value: '11', label: 'Option 32' },
      { value: '12', label: 'Option 42' },
    ],
  },
  argTypes: {
